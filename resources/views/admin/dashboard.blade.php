...
<head>
  ...
  <link rel="stylesheet" href="{{asset('tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.css')}}">
  <!-- iCheck -->
              ...
              <div class="card-body">
                ...
                <div class="direct-chat-contacts">
                  <ul class="contacts-list">
                    ...
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="{{asset('img/avatar5.png')}}" alt="User Avatar">
